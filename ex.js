...
`;
    ...
    conteudo.innerHTML = `
     <h2>Está tudo bem não estar perfeito. Vamos fazer algo que pode melhorar seu dia:</h2>
  ...
  <ul>
    ...
    <li>Incline a cabeça para cada lado, segurando por 10 segundos</li>
...
`;
    ...
    conteudo.innerHTML = `
  <h2>Sinto muito que você não esteja bem. Vamos tentar aliviar esse sentimento:</h2>
